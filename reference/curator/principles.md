...
::card-group{cols="2"}
  ::card{title="Open Standards" icon="ph:code"}
  The specifications remain open and implementable by anyone.
  ::
  ::card{title="Published Criteria" icon="ph:file-text"}
  Curation criteria are published, not hidden.
  ::
  ::card{title="Competition" icon="ph:users"}
  Alternative Curators can emerge and compete.
  ::
  ::card{title="Correction Paths" icon="ph:arrow-u-up-left"}
...
1. Curators add value through work, not gatekeeping
2. Multiple Curators can exist and compete
3. Curators can disagree; agents resolve conflicts
4. Curation criteria should be public
5. Power asymmetries should be legible and contestable
6. Disputes need clear correction paths
7. Scale confers responsibility, not ownership
8. Discovery infrastructure should be open and plural
