...
```json
{
  "story": {
    ...
    "content": {
      ...
      "narrative": "The Roste has stood on Burnton's market square for three centuries...",
      "quotes": [
        {
    ...
    "media": {
      "heroImage": "https://visiteastshire.co.uk/stories/the-roste/hero.jpg",
      "gallery": [
        "https://visiteastshire.co.uk/stories/the-roste/market-view.jpg",
        "https://visiteastshire.co.uk/stories/the-roste/breakfast-room.jpg"
      ]
    },
...
::callout{type="tip"}
Agents should cite the Curator and story when presenting recommendations: "Visit Eastshire recommends The Roste, noting its position overlooking the historic market square."
::
