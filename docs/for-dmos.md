...
1. Read the [Curator specification](/curator)
2. Publish a manifest at `/.well-known/curator.json`
3. Add venue certifications
4. Add stories as you capture them

Start with a handful of venues. The structure matters more than completeness.

---

*See also: [Venue](/venue) for what venues publish about themselves.*
