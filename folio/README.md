...
In hospitality, a folio is the running account of a guest's charges and payments. Folio defines what these transactions mean.
...
Folio is defined as a JSON Schema. When mapped onto UCP, it composes with checkout via `allOf`:

```json
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://agentic-hospitality.org/schemas/folio.json",
...
| Retail checkout | Hospitality folio |
|-----------------|---------------------------|
